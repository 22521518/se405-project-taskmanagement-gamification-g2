...
interface WorkspaceApi {
    suspend fun getProjectsByWorkspace(userId: Uuid, workspaceId: Uuid): List<Project>
    suspend fun getMembersByWorkspace(userId: Uuid, workspaceId: Uuid): List<WorkspaceMember>
}
